			...
			<div className='about-main-container'>
				...
				<div className='about-vision fade-in-left '>
					...
					<div className='about-vision-body'>
						...
						empowering athletes and sports enthusiasts around the
						world to reach their full potential. We strive to be the
						leading athletic brand globally, committed to delivering
						superior products and experiences that enhance
						performance and inspire a sense of greatness.
					</div>
				</div>
