  ...
  // const handleUpdateInventory = async (e, productId) => {
	...
	return (
		<div className='background-inventory'>
			...
			<thead className="table-inventory">
				<tr>
				<th>Id</th>
				<th>Name</th>
				</tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <button onClick={(e) => handleUpdateInventory(e, editingInventory.productID)}>
                    Update
                </button>
            </td>
        </tr>
        )}
        {!editingInventory && inventory.map((inventory) => (
        <tr key={inventory.productID}>
            ...
            <td>
                <button onClick={() => setEditingInventory(inventory)}>
                    Edit
                </button>
            </td>
        </tr>
